...
- combine the selected ASVs with the data in the tax table
	...
	- filter for the rows with a p-value < 0.05 and IV > 0.2
...
- Trim and denoise the samples to a read depth of n=150 using the DADA2 algorithm (used Q = 30, all scores above the threshold)
...
|--------------------------------|--------|----------------|----------------|------------------|---------------------------------------|---------------------------------------|-----------------------------------|------------|--------------------|---------|
|54da3e844b42d39369127a368dcced1e|Bacteria|Firmicutes      |Bacilli         |RF39              |_RF39_                                 |_RF39_                                 |_human gut_                        |Farm        |0.380               |0.040    |
|fdbdbe81dd5e0e2b71693fe87db9691d|Bacteria|Firmicutes      |Bacilli         |Erysipelotrichales|_Erysipelotrichaceae_                  |_Holdemanella_                         |_uncultured bacterium_             |Farm        |0.409               |0.045    |
|cbd66fa79a3e7fa1c33d29ed908de048|Bacteria|Firmicutes      |Bacilli         |Erysipelotrichales|_ Erysipelatoclostridiaceae_           |_Catenibacterium_                      |_NA_                               |Farm        |0.398               |0.025    |
|80dbd6cdd5798902a9038eb121f7f640|Bacteria|Firmicutes      |Clostridia      |Clostridia UCG-014|_ Clostridia UCG-014_                  |_Clostridia UCG-014_                   |_uncultured bacterium_             |No-farm     |0.501               |0.030    |
|ce7e172e3d64bc42dddb2f4aa26e3a03|Bacteria|Desulfobacterota|Desulfovibrionia|Desulfovibrionales|_Desulfovibrionaceae_                  |_Desulfovibrio_                        |_NA_                               |Farm        |0.553               |0.020    |
...
|ASV code                        |Domain  |Phylum          |Class           |Order             |Family                     |Genus            |Species                    |Indicator of|Indicator value (IV)|_p-value_|
|--------------------------------|--------|----------------|----------------|------------------|---------------------------|-----------------|---------------------------|------------|--------------------|---------|
|ce7e172e3d64bc42dddb2f4aa26e3a03|Bacteria|Desulfobacterota|Desulfovibrionia|Desulfovibrionales|_Desulfovibrionaceae_      |_Desulfovibrio_  |_Desulfovibrio piger_      |Farm        |0.553               |0.020    |
...
- identified a higher number of indicator taxa (ISA) with higher IV values, showing that filtering improved the identification of indicator taxa in the Model dataset
- the number of model taxa increased to 4!
	- interestingly, _Catenibacterium mitsuokai_ was found both in the filtered and the unfiltered datasets. However, the IV was not affected by filtering.
