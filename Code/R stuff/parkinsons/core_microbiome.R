...
# create vector of ASV ids with only antibiotic use samples
# create vector with non-antibiotic use samples
...
prune_taxa(nofarm_ASVs,phylobj) %>% 
  plot_bar(fill="Genus") + 
...
ggsave("core_ASVs_barplot(r.ab_0.01,prev_0.5).png", core_venn)
